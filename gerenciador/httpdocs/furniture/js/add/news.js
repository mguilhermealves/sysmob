...
data_news_json.template += '  <div class="cell" style="height: 45px;min-width: 70px !important;overflow:hidden;"#ADD_NAME#">#NAME#</div>';
data_news_json.template += '  <div class="cell" style="min-width: 70px !important;overflow:hidden;"#ADD_UPDATE#">#UPDATE#</div>';
data_news_json.template += '  <div class="cell" style="min-width: 70px !important;overflow:hidden;"#ADD_PERFIL#">#PERFIL#</div>';
data_news_json.template += '  <div class="cell cell_last" style="min-width: 70px !important;overflow:hidden;">#ACAO#</div>';
...
data_news_json.footer += ' <div class="cell cell_last table_data_footer" style="justify-content: space-around;" id="paginate_control"></div>';
data_news_json.footer += ' <div class="cell cell_last table_data_footer" id="paginate_display">#DATA_TOTAL#</div>';
data_news_json.footer += '</div>';
        ...
        $.each( data.row , function(i,o){
            ...
            fn_common.render_data( 
                ...
                , {
                    ...
                    , "#ADD_PERFIL#" : ''
                    , "#NAME#" :  o.name
        		    , "#STATUS#" : data_news_json.status_published_list[ o.new_status ] != undefined ? data_news_json.status_published_list[ o.new_status ]  : "-"
                    ...
                    , "#ACAO#" : '<a href="' + String( data_news_json.url_edit ).replace(/%s/,o.idx)  + '" style="width: 100%; background-color: #ffffff; color: #707070; text-align: left; font-weight: bold; padding: 0px;" id="btn_ordenation_status" type="button">Editar<i class="fa fa-edit"></i></a>'
                }
...
var fn_common = {
    ...
    paginate: function( sr ){
        ...
        if( paginate < data_news_json.out_data.total.total ){
            last_paginate = data_news_json.out_data.total.total % per_page == 0 ? data_news_json.out_data.total.total / per_page : ( Math.floor( data_news_json.out_data.total.total / per_page ) + 1 ) ;
