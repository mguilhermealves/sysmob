            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-lg-4">
                    <div class="form-group">
                        <label for="filter_cpf">CPF do Locador:</label>
                        <input type="text" id="filter_cpf" class="form-control" name="filter_cpf" value="<?php print(isset($info["get"]["filter_cpf"]) ? $info["get"]["filter_cpf"] : "") ?>" class="form-control" placeholder="Digite o CPF do Locador">
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-lg-2">
                    ...
                    <a id="btn_add" class="btn btn-primary btn-block btn-sm" title="Adicionar" href="<?php print($form["pattern"]["new"]) ?>"><i class="bi bi-plus-circle"></i> Novo</a>
                </div>
            </div>
            <hr>
        </form>
        ...
        <div class="col-lg-12" style="overflow: auto;">
            ...
            <table class="table table-striped table-inverse table-hover">
                <thead class="thead-inverse">
                    <tr>
                        <th><a style="color:#707070; text-decoration:none" href="<?php print(set_url($form["pattern"]["search"], array("ordenation" => $ordenation_nome_completo))) ?>">Nome do Locador <i class="<?php print($ordenation_nome_completo_ordenation) ?>"></i></a></th>
                ...
                <tbody>
                    ...
                    if ($total > 0) {
                        ...
                        <tr>
                            <td colspan="3">
                                <p class="alert alert-warning text-center">Nenhum Locador encontrado...</p>
                            </td>
                        </tr>
                    <?php
                    }
