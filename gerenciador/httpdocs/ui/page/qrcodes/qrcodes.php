            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="filter_name">Nome do QR code:</label>
                ...
                <div class="col-sm-2">
                    ...
                    <a id="btn_add" class="btn btn-primary btn-block btn-sm" title="Adicionar" href="<?php print($form["pattern"]["new"]) ?>"><i class="bi bi-plus-circle"></i> Novo QRcode</a>
                </div>
            </div>
        </form>
