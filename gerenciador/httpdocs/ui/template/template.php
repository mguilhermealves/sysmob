...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    <p>
                                        <?php print($_SESSION[constant("cAppKey")]["credential"]["first_name"]) ?> - Web Developer
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2014-2019 <a href="https://adminlte.io">Sistema Financeiro</a>.</strong> Todos os direitos reservados.
        </footer>
