...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'lucyane@aartelecom.com';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'Lucyane - AAR Telecom';
   ...
   * @var string
   */
  public $Sender            = 'lucyane@aartelecom.com';
   ...
   * @var string
   */
  public $Host          = 'a2plcpnl0228.prod.iad2.secureserver.net';
   ...
   * @var string
   */
  public $Username      = 'contato@aartelecom.com';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = '82JbU06ot=S(';
