            ...
            <div class="row">
                            ...
                            <div class="row padding-top-50 padding-bottom-50">
                                ...
                                <div class="col-6 padding-right-10">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="assunto" id="" class="form-control form-control-contacts" placeholder="">
                                    </div>
                                </div>

                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea class="form-control form-control-contacts" name="description" id="" rows="6" placeholder="Tell us how we can help you" style="resize: none;"></textarea>
                                    </div>
                                </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="row">
                        ...
                        <div class="col-12 margin-top-20 margin-left-70 xs-margin-left-0" id="sc-map">
                        ...
                        <div class="col-12 d-none margin-top-20 margin-left-70 xs-margin-left-0" id="sp-map">
                        ...
                        <div class="col-12 d-none margin-top-20 margin-left-70 xs-margin-left-0" id="ch-map">
